        ...
        axiosSecure.post('/payment', paymentInfo)
            .then(() => {
                ...
                Swal.fire({
                    ...
                    icon: 'success',
                    confirmButtonColor: '#592ADF', // Purple color
                }).then(() => {
                    navigate('/Dashboard/My-enroll-class'); // Redirect to home page
                });
            })
            .catch((error) => {
                Swal.fire({
                    ...
                    icon: 'error',
                    confirmButtonColor: '#F22480', // Pink color
                });
            });
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 max-md:order-1">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="mt-8 max-w-lg">
                            <div className="grid gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="px-4 py-3.5 bg-gray-100 text-gray-800 w-full text-sm border rounded-md focus:border-[#592ADF] focus:bg-transparent outline-none"
                                    />
                                ...
                                <div>
                                    ...
                                    <div className="flex bg-gray-100 border rounded-md focus-within:border-[#592ADF] focus-within:bg-transparent overflow-hidden">
                            ...
                            <button
                                type="submit"
                                className="mt-8 w-40 py-3.5 text-sm bg-[#592ADF] text-white rounded-md hover:bg-[#FFBB01] tracking-wide"
                            >
                                Pay
                            </button>
                        </form>
